...
def search_list_by_channel(service, part, max_results, channel, type):
...
search_list_by_channel(youtube, 'title', 25, 'UCtI0Hodo5o5dUb67FeUjDeA', 'video')


#channels_list_by_id(youtube, 'snippet,statistics', 'UCtI0Hodo5o5dUb67FeUjDeA')